...
# ------------------------------------------------------------------------------
output "vpc_id" {
  description = "VPC ID for WorkSpaces infrastructure in us-east-1"
  value       = local.vpc_id
}
...
output "management_subnet_ids" {
  description = "Management subnet IDs in us-east-1"
...
# ------------------------------------------------------------------------------
# DOMAIN CONTROLLER REFERENCES (from account-111122223333)
# ------------------------------------------------------------------------------
...
output "dc_transit_gateway_id" {
  description = "Transit Gateway ID in us-east-2 (DC region)"
  value       = local.dc_tgw_id
}
