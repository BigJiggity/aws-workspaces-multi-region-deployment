# Terragrunt deployment unit for: WorkSpaces dev (us-east-2)
...
remote_state {
  ...
  config = {
    ...
    key            = "workspaces/platform/us-east-2/dev.tfstate"
...
locals {
  ...
  unit_path     = "live/aws/aws-workspaces-platform/account-111122223333/us-east-2/dev"
