# Terragrunt deployment unit for: WorkSpaces SOC pool (us-east-1)
...
remote_state {
  ...
  config = {
    ...
    key            = "workspaces/platform/us-east-1/soc-pool.tfstate"
...
locals {
  ...
  unit_path     = "live/aws/aws-workspaces-platform/account-111122223333/us-east-1/soc-pool"
