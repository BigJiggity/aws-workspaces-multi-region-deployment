# Terragrunt deployment unit for: WorkSpaces standard (us-east-1)
...
terraform {
  source = "${get_terragrunt_dir()}/../../../../../../modules/source/aws/aws-workspaces-platform/account-111122223333//us-east-1"
}
...
remote_state {
  ...
  config = {
    ...
    key            = "workspaces/platform/us-east-1/standard.tfstate"
...
locals {
  ...
  unit_path     = "live/aws/aws-workspaces-platform/account-111122223333/us-east-1/standard"
  source_path   = "modules/source/aws/aws-workspaces-platform/account-111122223333/us-east-1"
