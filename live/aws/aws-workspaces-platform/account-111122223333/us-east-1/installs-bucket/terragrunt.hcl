# Terragrunt deployment unit for: installs-bucket (us-east-1)
...
terraform {
  source = "${get_terragrunt_dir()}/../../../../../../modules/source/aws/aws-workspaces-platform/account-111122223333//us-east-1/installs-bucket"
}
...
remote_state {
  ...
  config = {
    ...
    key            = "workspaces/platform/us-east-1/installs-bucket.tfstate"
...
locals {
  ...
  unit_path     = "live/aws/aws-workspaces-platform/account-111122223333/us-east-1/installs-bucket"
  source_path   = "modules/source/aws/aws-workspaces-platform/account-111122223333/us-east-1/installs-bucket"
