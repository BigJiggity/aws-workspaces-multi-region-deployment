# Terragrunt deployment unit for: WorkSpaces Dev pool (us-east-1)
...
remote_state {
  ...
  config = {
    ...
    key            = "workspaces/platform/us-east-1/dev-pool.tfstate"
...
locals {
  ...
  unit_path     = "live/aws/aws-workspaces-platform/account-111122223333/us-east-1/dev-pool"
...
inputs = {
  ...
  pool_name        = "example-workspaces-platform-dev-dev-pool-v1"
  pool_description = "Dev WorkSpaces pool"
  ...
  bundle_id = local.common_cfg.locals.default_bundles.dev
  ...
  application_settings_group  = "example-workspaces-platform-dev/dev-pool-v1"
