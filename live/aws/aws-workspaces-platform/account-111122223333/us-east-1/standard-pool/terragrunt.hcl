# Terragrunt deployment unit for: WorkSpaces Standard pool (us-east-1)
...
terraform {
  source = "${get_terragrunt_dir()}/../../../../../../modules/source/aws/aws-workspaces-platform/account-111122223333//us-east-1/workspaces-pool-soc"
}
...
remote_state {
  ...
  config = {
    ...
    key            = "workspaces/platform/us-east-1/standard-pool.tfstate"
...
locals {
  ...
  common_cfg   = read_terragrunt_config(find_in_parent_folders("live/aws/aws-workspaces-platform/account-111122223333/us-east-1/common.hcl"))

  unit_path     = "live/aws/aws-workspaces-platform/account-111122223333/us-east-1/standard-pool"
  source_path   = "modules/source/aws/aws-workspaces-platform/account-111122223333/us-east-1/workspaces-pool-soc"
...
inputs = {
  ...
  pool_name        = "example-workspaces-platform-dev-standard-pool-v1"
  pool_description = "Standard WorkSpaces pool"
  ...
  saml_xml_secret_arn = "arn:aws:secretsmanager:us-east-1:111122223333:secret:REPLACE_WITH_SAML_XML_SECRET"

  bundle_id = local.common_cfg.locals.default_bundles.standard
  ...
  application_settings_group  = "example-workspaces-platform-dev/standard-pool-v1"
  ...
  tags = merge(local.global_cfg.locals.tags, {
    ...
    Purpose       = "Standard Pool Sessions"
