# Terragrunt deployment unit for: live/aws/aws-ssm/account-111122223333
#
...
terraform {
  source = "${get_repo_root()}//modules/source/aws/aws-ssm/account-111122223333"
}
...
locals {
  ...
  stack_cfg    = read_terragrunt_config(find_in_parent_folders("live/aws/aws-ssm/stack.hcl"))

  unit_path     = "live/aws/aws-ssm/account-111122223333"
  source_path   = "modules/source/aws/aws-ssm/account-111122223333"
