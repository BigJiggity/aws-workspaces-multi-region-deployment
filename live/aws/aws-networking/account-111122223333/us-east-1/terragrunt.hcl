# Terragrunt deployment unit for: live/aws/aws-networking/account-111122223333/us-east-1
#
...
terraform {
  source = "${get_repo_root()}//modules/source/aws/aws-networking/account-111122223333/us-east-1"
}
...
locals {
  ...
  unit_path     = "live/aws/aws-networking/account-111122223333/us-east-1"
  source_path   = "modules/source/aws/aws-networking/account-111122223333/us-east-1"
