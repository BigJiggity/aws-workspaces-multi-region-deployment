# Terragrunt deployment unit for: live/aws/aws-networking/account-111122223333/us-east-2
#
...
terraform {
  source = "${get_repo_root()}//modules/source/aws/aws-networking/account-111122223333/us-east-2"
}
...
locals {
  ...
  stack_cfg    = read_terragrunt_config(find_in_parent_folders("live/aws/aws-networking/stack.hcl"))

  unit_path     = "live/aws/aws-networking/account-111122223333/us-east-2"
  source_path   = "modules/source/aws/aws-networking/account-111122223333/us-east-2"
