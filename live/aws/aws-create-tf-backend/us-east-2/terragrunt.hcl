# Terragrunt deployment unit for: live/aws/aws-create-tf-backend/us-east-2
#
...
terraform {
  source = "${get_repo_root()}//modules/source/aws/aws-create-tf-backend/us-east-2"
}
...
locals {
  ...
  stack_cfg    = read_terragrunt_config(find_in_parent_folders("live/aws/aws-create-tf-backend/stack.hcl"))

  unit_path     = "live/aws/aws-create-tf-backend/us-east-2"
  source_path   = "modules/source/aws/aws-create-tf-backend/us-east-2"
  account_scope = "us-east-2"
  region        = ""
}
